...
<html lang="en"  direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title> Mandub Admin panel</title>
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">مـــــــــرحبا بك فى 
						<br />منــــــــــــدوبـــــــــــى</h3>
						<!--end::Aside title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
						...
						<div class="login-form login-signin">
							...
							<form class="form" method="POST" action="{{ route('login') }}"  id="kt_login_signin_form" style="text-align: right;">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" id="email" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}"  autofocus />
									@error('email')
								...
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										<label class="font-size-h6 font-weight-bolder text-dark pt-5">كلمه المرور</label>
										
									</div>
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password"/>
					...
					<div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
						...
						<a href="#" class="text-primary font-weight-bolder font-size-lg">حقوق الملكيه @ </a>
							<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">مندوبى </a>
						</div>
