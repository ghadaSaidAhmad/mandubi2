...
class GovernoratesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //encode json
        $jsonData = json_decode($governorates, true);  
        //loop and insert in table 
        foreach($jsonData as $value){
            $tableArray = [
                'name_ar' => $value['governorate_name_ar'] ,  
                'name_en' => $value['governorate_name_en']           
            ];
            //creating the record in database
            \DB::table('governorates')->insert($tableArray );
        }
